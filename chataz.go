...
const (
	azureBaseURL    = "https://dxc-foundry-ai-dev.services.ai.azure.com/anthropic"
...
func main() {
	...
	if apiKey == "" {
		log.Fatal("AZURE_ANTHROPIC_API_KEY environment variable is required")
	}
...
func (a *Agent) runInference(ctx context.Context, conversation []anthropic.MessageParam) (*anthropic.Message, error) {
	if a.verbose {
		log.Printf("Making API call to Azure deployment: %s", azureModelName)
	}
